...
In a domain which fetishizes certainty these gaps have been dramatised as failures. But the error is to make of statistics a monolith; although there is an arcane system of tools and symbols common across topics, no sample is large enough to address all questions you could ask.  Reasoning from small samples is common, best done with caution and plenty of caveats, but better reason than not. Expectations should be modified accordingly.
